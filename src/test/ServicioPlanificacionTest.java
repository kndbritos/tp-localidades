...
public class ServicioPlanificacionTest {
    ...
    public void generarGrafoCompletoDebeCrearAristas() {
        ...
        Localidad a = new Localidad("A", "Buenos Aires", -34.0, -58.0, 0);
        Localidad b = new Localidad("B", "Cordoba", -31.0, -64.0, 1);

        localidades.add(a);
        localidades.add(b);

        GrafoConPeso grafo = servicio.generarGrafoCompleto(localidades, 100);
